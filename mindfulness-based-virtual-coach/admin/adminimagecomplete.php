<?php
  ...
  if(isset($_SESSION['client_session'])){
    ...
    header('location:adminclientdetails.php');
  }
  ...
  <div id='mycontainer'>
    ...
    <?php
      ...
      if(!in_array($filetype, $allowed)) {
        echo"
          <div class='card'>
            <p class='mt-2 ml-2'><strong>Only jpg, jpeg, gif and png files are allowed. Go <a href='adminclientdetails.php'>back</a> to try again.</p></strong></p>
          </div>
        ";
      }else{
        ...
        if($moved){
          ...
          echo"
            <div class='card'>
              <p class='mt-2 ml-2'><strong>Image uploaded successfully. Go <a href='adminclientdetails.php'>back</a> to change home page images.</strong></p>
            </div
          ";
          $stmt->close();
        }else{
